...
public class POJOPracticeWithSpartanApp {
    ...
    @Test
    @DisplayName("Retrieve exiting user, update name and verify tat name was updated successfully")
    public void updateSpartanTest() {
        int userToUpdate = 156;
        String name = "Olya";
    ...
    public void patchUserTest1() {
        ...
        given().
                ...
                then().
                assertThat().statusCode(200).body("name", is("Slav"));
