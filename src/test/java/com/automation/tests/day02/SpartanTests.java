...
public class SpartanTests {
    ...
    @Test
    @DisplayName("Get list of spartans") // optional
    ...
    public void addSpartan(){
        ...
        String body="{\"gender\": \"Female\", \"name\": \"Olinka User\",\"phone\": 9988997789}";
        ...
        // System.getProperty("user.dir") --> location of this project and /spartan.json--> name of package
    ...
    public void deleteSpartanTest(){
     ...
     given().
             ...
             baseUri(BASE_URL).
     when().
           delete("/api/spartans/{id}",945) .prettyPeek().
     then().
             statusCode(204);
