...
public class WeatherAPP {
    ...
    public static void main(String[] args) {
       ...
       // String woeid = getWOEID(city);
        ...
        System.out.println();
        String woeid1 = getWOEID(city);
        printWeatherInfo1(woeid1);
    }
    ...
    public static void printWeatherInfo1(String woeid1) {
        woeid1 = woeid1.replaceAll("\\D", "");//to delete all non-digits
        Response response = get("{woeid1}", woeid1);
        List<String> weatherStateName = response.jsonPath().getList("consolidated_weather.weather_state_name");
