...
public class ORDSTests {
    ...
    @Test
    @DisplayName("Get list of employees")
...
Response response = given().baseUri(BASE_URL).when().get("/employees").prettyPeek();//it lets us to save our response
        //prettyPeek() displays entire response information
    ...
    public void getOneEmployee(){
        ...
        // you can do <code>get("/book/{hotelName}/{roomNumber}", "Hotels R Us", 22);
        // </code>.
